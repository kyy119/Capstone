...
class HelloGeoActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    renderer = HelloGeoRenderer(this,intent.getStringExtra("place_name"),intent.getDoubleExtra("x",0.0),intent.getDoubleExtra("y",0.0),intent.getDoubleExtra("z",0.0))

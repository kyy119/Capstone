...
class HelloGeoRenderer(val activity: HelloGeoActivity,var place_name:String?,var place_x:Double,var place_y:Double,var place_z:Double) :
...
//    var latitude:Int?
//    latitude=cameraintent.getIntExtra("x")
    ...
    val qw=1f
    earthAnchor =
      earth.createAnchor(place_x, place_y,place_z, qx, qy, qz, qw)

    println("x=$place_x,y=$place_y,z=$place_z,$qx,$qy,$qz,$qw")
